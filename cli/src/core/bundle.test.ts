...
import { addEntry, artifactMarker, removeEntry } from "./manifest.js";
...
function pathFor(type: ArtifactType, name: string): string {
...
describe("buildBundle", () => {
  ...
  it("copies commands and rules to explicit plugin locations", async () => {
    ...
    expect(await readFile(join(result.dir, "README.md"), "utf8")).toContain("copy these files manually");
  });
